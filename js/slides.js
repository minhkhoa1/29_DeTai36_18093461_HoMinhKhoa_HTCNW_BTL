 (function() {
     ...
     function k(b, c) {
         ...
         function x(a) {
             ...
             f.pause_button && "manual" != f.play_type && (n.after(""),
         ...
         function T() { f.buttons && (n.after("<div class='ism-button ism-button-prev fas1 fas fa-caret-square-left'>&nbsp;</div><div class='ism-button ism-button-next fas1 fas fa-caret-square-right'>&nbsp;</div>"), E = d("#" + b + " .ism-button-prev"), D = d("#" + b + " .ism-button-next"), E.on("click", J), E.on("touchstart", J), D.on("click", K), D.on("touchstart", K)) }
